...
namespace Pds {
  ...
  public:
    ...
    enum Service {NoOp    ,  L1Accept,  Service2,  Service3,
                  ...
                  Service24, Service25, Service26, Service27,
                  Service28, Service29, Service30, Service31};
    enum         {NumberOfServices = 32};
  ...
  private:
    ...
    enum {v_seqType  = 29, k_seqType  = 2, m_seqType  = ((1 << k_seqType)-1)};
