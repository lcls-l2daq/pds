...
{ 
  ...
  if (_bDelayMode)
  {
    ...
    {
      printf( "FliServer::~FliServer(): Catpure task is running. Wait for it to terminate...\n" );
      ...
      {
        printf( "FliServer::~FliServer(): timeout for waiting thread terminating\n" );
        break;
      }
    }
  }
...
int FliServer::init()
{
  ...
  iError = FLIGetArrayArea( _hCam, &iDatX, &iDatY, &iDatW, &iDatH);
  if (iError != 0)
  {
