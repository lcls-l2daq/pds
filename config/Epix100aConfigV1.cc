...
namespace Pds {
  namespace Epix100aConfig {
    ...
    //offset shift mask default readOnly
        ...
        { 10,  0, 0xffffffff, 0xa,        0},    //  AsicRoClkHalfT,
        { 11,  0, 3,          1,          0},    //  AdcReadsPerPixel,
        { 12,  0, 0xffffffff, 1,          0},    //  AdcClkHalfT,
        { 13,  0, 0xffffffff, 0x26,       0},    //  AsicR0Width,
        { 14,  0, 0xffffffff, 0x11,       0},    //  AdcPipelineDelay,
        { 15,  0, 0xffff,     0x26,       0},    //  SnycWidth,
        { 15, 16, 0xffff,     0x26,       0},    //  SyncDelay,
        { 16,  0, 0xffffffff, 0x26,       0},    //  PrepulseR0Width,
        { 17,  0, 0xffffffff, 0x9c40,     0},    //  PrepulseR0Delay,
        { 18,  0, 0xffffffff, 0,          1},    //  DigitalCardId0,
        { 19,  0, 0xffffffff, 0,          1},    //  DigitalCardId1,
        { 20,  0, 0xffffffff, 0,          1},    //  AnalogCardId0,
        { 21,  0, 0xffffffff, 0,          1},    //  AnalogCardId1,
