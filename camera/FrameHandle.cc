...
FrameHandle::FrameHandle(unsigned long _width, unsigned long _height, enum FrameHandle::Format _format, void *_data):
...
FrameHandle::FrameHandle(unsigned long _width, unsigned long _height, enum Format _format, int _elsize, void *_data):
