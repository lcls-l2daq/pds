...
static const uint8_t write_values[] = {
 //  4 x 125MHz
  /*
...
void Pds::QuadAdc::ClkSynth::dump() const
{
  volatile uint32_t* r255 = const_cast<Pds::QuadAdc::ClkSynth*>(this)->_reg+255;
  *r255 = 0;
...
void Pds::QuadAdc::ClkSynth::setup()
{
